...
int main() {
   ...
   cl_float Atmp[MATRIX_DIM*MATRIX_DIM] = { 0.271859, 0.708396, 0.370037, 0.502304, 0.161687,
											0.291757, 0.246345, 0.839839, 0.712577, 0.560167,
											0.844081, 0.339885, 0.826991, 0.890683, 0.278603,
											0.416303, 0.482742, 0.192083, 0.796594, 0.910062,
											0.915281, 0.983459, 0.665792, 0.043489, 0.879788 };

   /* Initialize A matrix */
   srand((unsigned int)time(0));
   for(i=0; i<MATRIX_DIM; i++) {
      for(j=0; j<MATRIX_DIM; j++) {
		 a_mat[i][j] = Atmp[i*MATRIX_DIM + j];//(float)rand()/RAND_MAX;
         check_mat[i][j] = 0.0f;
      }
   }
